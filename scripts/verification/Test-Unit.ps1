...
$approvedInstalledAssetSkips = @(
  ...
  'OpenRCT3.Tests.Simulation.ModelAnimationPoseEvaluatorTests.Evaluate_InstalledAdultElephantUsesItsExactWadSlotPeriod',
  ...
  'OpenRCT3.Tests.Simulation.WildAnimalFrameZeroPoseRegistryTests.Build_InstalledOstrichRetainsAndEvaluatesEveryVariantWadSlot',
  'OpenRCT3.Tests.Simulation.WildAnimalFrameZeroSceneLoaderTests.OstrichFarm_LoadsOnlyProvableFrameZeroClipsAndRetainsTypedSkips',
  ...
  'OpenRCT3.Tests.Simulation.WildAnimalSavedAnimationResolverTests.ResolveInstalled_OstrichFarmRetainsAllNativeStates',
